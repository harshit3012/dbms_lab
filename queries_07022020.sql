...
use insurance;
show tables;
create table PERSON(driver_id varchar(30) NOT NULL UNIQUE, name varchar(50) NOT NULL, address longtext not null, primary key(driver_id));
#create table owns(driver_id varchar(30) not null unique, reg_num varchar(30) not null unique, primary key(driver_id, reg_num), foreign key(
create table CAR(reg_num varchar(30) not null unique, model varchar(20) not null, year int(4) not null, primary key(reg_num));

create table ACCIDENT(report_num int(20) not null unique, accident_name date not null, location varchar(20) not null, PRIMARY KEY(report_num));
create table PARTICIPATED(driver_id varchar(30) NOT NULL, reg_num varchar(30) not null unique, report_num int(20) not null unique, damage_amount float not null, primary key(driver_id, reg_num, report_num), FOREIGN KEY (driver_id) references PERSON(driver_id), foreign key (reg_num) references CAR(reg_num), foreign key (report_num) references ACCIDENT(report_num));create table OWNS(driver_id varchar(30) not null unique, reg_num varchar(30) not null unique, primary key(driver_id, reg_num), foreign key (driver_id) references PERSON(driver_id), foreign key (reg_num) references CAR(reg_num));
...
INSERT INTO ACCIDENT(report_num, accident_name, location) values (11, '01-01-03', "Mysore Road");
INSERT INTO ACCIDENT(report_num, accident_name, location) values (12, '02-02-04', "South End Circle");
INSERT INTO ACCIDENT(report_num, accident_name, location) values (13, '2003-01-21', "Bull Temple Road");
INSERT INTO ACCIDENT(report_num, accident_name, location) values (14, '2008-02-17', "Mysore Road");
INSERT INTO ACCIDENT(report_num, accident_name, location) values (15, '2005-03-04', "Kanakpura Road");
